...
import { getLockedFilters, mergeFilters } from '@/util/filterContext'
...
export default function BrandPage() {
    ...
    const lockedFilters = { make: brandName }
    ...
    return (
        <Layout headerStyle={3} footerStyle={1}>
            <Breadcrumb 
                breadcrumbTitle={`${brandName} Inventory`}
                breadcrumbSubTitle={`Browse all ${brandName} products`}
            />
