...
export default function UsagePage() {
    ...
    const usageName = decodeURIComponent(params.usage)
    const lockedFilters = { usage: usageName }
    ...
    return (
        <Layout headerStyle={3} footerStyle={1}>
            <Breadcrumb 
                breadcrumbTitle={`${usageName} Inventory`}
                breadcrumbSubTitle={`Browse all ${usageName} products`}
            />
